    ...
    public class RubyBeetle : BaseBeetleNPC
    {
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            if (NPC.life <= 0 && Main.netMode != NetmodeID.Server)
            {
                ...
                int Gore1 = ModContent.Find<ModGore>("Urdveil/RBeetle1").Type;
                int Gore2 = ModContent.Find<ModGore>("Urdveil/RBeetle2").Type;
                int Gore3 = ModContent.Find<ModGore>("Urdveil/RBeetle3").Type;
                int Gore4 = ModContent.Find<ModGore>("Urdveil/RBeetle4").Type;
                int Gore5 = ModContent.Find<ModGore>("Urdveil/RBeetle5").Type;
