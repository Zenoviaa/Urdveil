...
using Urdveil.Items.Weapons.Mage.Tomes;
using Urdveil.NPCs.Bosses.DaedusTheDevoted;
using System;
...
namespace Urdveil.NPCs.Town
{
    internal class DaedusLibrarian : VeilTownNPC
    {
        ...
        public override string Texture => "Urdveil/NPCs/Bosses/DaedusTheDevoted/DaedusTheDevoted";
