...
using Urdveil.Items.Armors.Vanity.Gia;
    ...
    public class GiaPersonProfile : ITownNPCProfile
    {
        ...
        public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
        {
            if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
                return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Gia");

            if (npc.altTexture == 1)
                return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Gia_Party");

            return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Gia");
        }

        public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("Urdveil/NPCs/Town/Gia_Head");
    }
}