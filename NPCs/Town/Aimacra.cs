...
using Urdveil.Items.Armors.Vanity.Aimacra;
using Urdveil.Items.Consumables;
using Urdveil.Items.Weapons.Thrown.Jugglers;
...
namespace Urdveil.NPCs.Town
{
    ...
    [AutoloadHead]
    public class Aimacra : VeilTownNPC
    {
        ...
        public override void OnChatButtonClicked(bool firstButton, ref string shop)
        {
            ...
            if (!firstButton)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Bliss2"));
    ...
    public class AimacraPersonProfile : ITownNPCProfile
    {
        ...
        public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
        {
            if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
                return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Aimacra");

            if (npc.altTexture == 1)
                return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Aimacra_Party");

            return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Aimacra");
        }

        public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("Urdveil/NPCs/Town/Aimacra_Head");
    }
}