    ...
    public class GambitPersonProfile : ITownNPCProfile
    {
        ...
        public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
        {
            if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
                return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Gambit");

            if (npc.altTexture == 1)
                return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Gambit_Party");

            return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Gambit");
        }

        public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("Urdveil/NPCs/Town/Gambit_Head");
    }
}