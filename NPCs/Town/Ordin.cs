    ...
    public class Ordin : ModNPC
    {
        ...
        public override void OnChatButtonClicked(bool firstButton, ref string shop)
        {
            ...
            if (firstButton)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Bliss2")); // Reforge/Anvil sound
        ...
        public override void AddShops()
        {
            ...
            var npcShop = new NPCShop(Type, ShopName)
                    ...
                    {
                        shopCustomPrice = 3,
                        shopSpecialCurrency = Urdveil.MOACurrencyID // omit this line if shopCustomPrice should be in regular coins.
                    })
                    ...
                    {
                        shopCustomPrice = 3,
                        shopSpecialCurrency = Urdveil.MOBCurrencyID // omit this line if shopCustomPrice should be in regular coins.
                    })

                    .Add(new Item(ModContent.ItemType<Helios>())
                    {
                        shopCustomPrice = 3,
                        shopSpecialCurrency = Urdveil.MOCCurrencyID // omit this line if shopCustomPrice should be in regular coins.
                    })
                     ...
                     {
                         shopCustomPrice = 1,
                         shopSpecialCurrency = Urdveil.MOLCurrencyID // omit this line if shopCustomPrice should be in regular coins.
                     })
