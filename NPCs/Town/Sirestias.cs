    ...
    public class Sirestias : VeilTownNPC
    {
        ...
        public class DelgrimPersonProfile : ITownNPCProfile
        {
            ...
            public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
            {
                if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
                    return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Sirestias");

                if (npc.altTexture == 1)
                    return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Sirestias_Head");

                return ModContent.Request<Texture2D>("Urdveil/NPCs/Town/Sirestias");
            }

            public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("Urdveil/NPCs/Town/Sirestias_Head");
        }
        ...
        public override void OnChatButtonClicked(bool firstButton, ref string shop)
        {
            if (!firstButton)
            {
                ...
                //-----------------------------------------------------------------------------------------------
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Bliss1"));
