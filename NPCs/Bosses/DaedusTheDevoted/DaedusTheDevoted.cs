...
using Urdveil.NPCs.Bosses.DaedusTheDevoted.Projectiles;
...
namespace Urdveil.NPCs.Bosses.DaedusTheDevoted
{
    internal class BaseDaedusSegment
    {
        ...
        public string BaseTexturePath => "Urdveil/NPCs/Bosses/DaedusTheDevoted/";
    ...
    internal class DaedusRobeSegment : BaseDaedusSegment
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            MiscShaderData shaderData = GameShaders.Misc["Urdveil:DaedusRobe"];
    ...
    internal class DaedusTheDevoted : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "Urdveil/NPCs/Bosses/DaedusRework/DaedusBestiary",
        ...
        public override void SetDefaults()
        {
            ...
            NPC.DeathSound = new SoundStyle("Urdveil/Assets/Sounds/StormDragon_Bomb");
        ...
        public override void AI()
        {
            ...
            if (TeleportTarget != Vector2.Zero)
            {
                ...
                SoundStyle teleportStyle = new SoundStyle("Urdveil/Assets/Sounds/StarFlower1");
            ...
            if (BigTeleportTarget != Vector2.Zero)
            {
                ...
                SoundStyle teleportStyle = new SoundStyle("Urdveil/Assets/Sounds/StarFlower3");
                SoundEngine.PlaySound(teleportStyle, NPC.position);
            }
        ...
        private void AI_Phase2Transition()
        {
            switch (AttackCounter)
            {
                ...
                case 1:
                    ...
                    if (Timer % divisor == 0)
                    {
                        SoundStyle laughSound = new SoundStyle("Urdveil/Assets/Sounds/Jack_Laugh");
            ...
            switch (AttackCounter)
            {
                ...
                case 1:
                    ...
                    if (Timer % 60 == 0 && Timer < 240)
                    {
                        ...
                        SoundStyle laughSound = new SoundStyle("Urdveil/Assets/Sounds/Ticking");
