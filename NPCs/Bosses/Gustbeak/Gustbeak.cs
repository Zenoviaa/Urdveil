...
using Urdveil.Common.DrawEffects;
using Urdveil.Common.Lights;
using Urdveil.Gores;
using Urdveil.Helpers;
using Urdveil.Items.Placeable;
using Urdveil.NPCs.Bosses.Gustbeak.Projectiles;
...
namespace Urdveil.NPCs.Bosses.Gustbeak
{
    [AutoloadBossHead]
    internal partial class Gustbeak : BaseColosseumNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "Urdveil/NPCs/Bosses/Gustbeak/Gustbeak",
        ...
        private void AI_Spawn()
        {
            ...
            if (NPC.collideY && NPC.velocity.Length() > 1)
            {
                ...
                SoundStyle clankSound = new SoundStyle("Urdveil/Assets/Sounds/Gintze_Hit");
        ...
        private void AI_Idle()
        {
            ...
            if (Timer % 7 == 0)
            {
                SoundStyle wingFlap = new SoundStyle($"Urdveil/Assets/Sounds/NiiviWingFlap");
        ...
        private void AI_WindBlast()
        {
            ...
            {
                WindCharge = 0;
                SoundStyle windCast = new SoundStyle($"Urdveil/Assets/Sounds/WindCast", variantSuffixesStart: 1, numVariants: 2);
