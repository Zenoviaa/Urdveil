...
using Urdveil.Projectiles.Slashers.ScarecrowSaber;
using System.IO;
using Terraria;
using Terraria.Audio;
using Terraria.ID;

namespace Urdveil.NPCs.Bosses.CommanderGintzia.Hands
{
        ...
        protected override void AI_Attack()
        {
            ...
            else
            {
                ...
                if (Timer == 90)
                {
                    ...
                    SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/SwordThrow");
                    soundStyle.PitchVariance = 0.1f;
                    SoundEngine.PlaySound(soundStyle, NPC.position);
                }
