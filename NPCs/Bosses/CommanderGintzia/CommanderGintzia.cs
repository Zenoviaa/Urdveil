...
using Urdveil.NPCs.Bosses.CommanderGintzia.Hands;
    ...
    internal class CommanderGintzia : BaseColosseumNPC
    {
        ...
        private void AI_Spawn()
        {
            ...
            void PlaySound()
            {
                ...
                {
                    case 0:
                        soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GintzSummon");
                        soundStyle.PitchVariance = 0.1f;
                        SoundEngine.PlaySound(soundStyle, NPC.position);
                        break;
                    case 1:
                        soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GintzSummon2");
                        soundStyle.PitchVariance = 0.1f;
                        SoundEngine.PlaySound(soundStyle, NPC.position);
                        break;
                }
        ...
        private void AI_Land()
        {
            ...
            if (Timer == 1)
            {
                ...
                SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/Verifall");
