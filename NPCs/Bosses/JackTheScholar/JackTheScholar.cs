...
using Urdveil.Items.Accessories.Igniter;
...
using Urdveil.NPCs.Bosses.JackTheScholar.Projectiles;
using Terraria;
...
namespace Urdveil.NPCs.Bosses.JackTheScholar
{
    [AutoloadBossHead]
    internal class JackTheScholar : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            drawModifiers.CustomTexturePath = "Urdveil/NPCs/Bosses/Jack/JackBestiary";
                ...
                case 0:
                    if (Timer == 1)
                    {
                        ...
                        */
                        ...
                        SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/Jack_Laugh");
            ...
            switch (AttackCycle)
            {
                case 0:
                    ...
                    if (Timer == 1)
                    {
                        ...
                        NPC.velocity.X = DirectionToTarget.X * jumpHorizontalSpeed;
                        SoundStyle jumpStyle = new SoundStyle("Urdveil/Assets/Sounds/Jack_Jump");
                    ...
                    {
                        SoundStyle wee = new SoundStyle("Urdveil/Assets/Sounds/Jack_Land");
