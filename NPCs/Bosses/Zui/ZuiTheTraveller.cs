...
using Urdveil.Items.Armors.Vanity.Verlia;
...
namespace Urdveil.NPCs.Bosses.Zui
{
    ...
    public class ZuiTheTraveller : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            drawModifiers.CustomTexturePath = "Urdveil/NPCs/Bosses/Zui/ZuiBestiary";
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D syliaWingsTexture = ModContent.Request<Texture2D>("Urdveil/NPCs/Bosses/Zui/ZuiElement").Value;
        ...
        private void StartZui()
        {
            ...
            if (timer == 1)
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GoldenAura2"), NPC.position);
                if (StellaMultiplayer.IsHost)
                {
        ...
        private void BeamsZui()
        {
            ...
            if (timer == 1)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Laserlock"), NPC.position);

                        break;
                    case 1:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Laserlock2"), NPC.position);
                        break;
        ...
        private void RaysZui()
        {
            ...
            if (timer < 150)
            {
                if (rayer == 9)
                {
                    ...
                    {
                        case 0:
                            SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Gold1"), NPC.position);

                            break;
                        case 1:
                            SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Gold2"), NPC.position);
                            break;
                        case 2:
                            SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Gold3"), NPC.position);
                            break;
        ...
        private void GoldenBoltsZui()
        {
            ...
            //SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Moaning"), NPC.position);
            //SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/SwordHoldVerlia"), NPC.position);
        ...
        private void HomeRunZui()
        {
            ...
            if (timer == 1)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Zoee"));
            ...
            if (timer == 32)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/AbsoluteSwing"));
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Hyuh"));
            ...
            if (timer == 55)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GoldPrice4"), NPC.position);

                        break;
                    case 1:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GoldenPrice5"), NPC.position);
                        break;
                    case 2:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GoldenPrice6"), NPC.position);
                        break;

                }
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/SunStalker_PreSpawn"));
        ...
        private void SlasherZui()
        {
            ...
            if (timer == 32)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GoldenSlice1"), NPC.position);

                        break;
                    case 1:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GoldenSlice2"), NPC.position);
                        break;
                    case 2:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GoldenSlice3"), NPC.position);
                        break;
        ...
        private void SonicGroundpound()
        {
            ...
            if (timer == 1)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/CorsageRune2"), NPC.position);
                switch (Main.rand.Next(3))
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/SunStalker_Charge"), NPC.position);
            ...
            if (timer >= 15)
            {
                ...
                if (NPC.collideY || timer >= 120)
                {
                    ...
                    if (yud >= 10)
                    {
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GoldenFall"), NPC.position);
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Verifall"));
        ...
        private void SonicZui()
        {
            ...
            if (timer == 1)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GW1"));

                        break;
                    case 1:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GW2"));
                        break;
                    case 2:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/GW3"));
                        break;
