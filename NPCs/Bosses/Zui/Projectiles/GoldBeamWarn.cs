...
namespace Urdveil.NPCs.Bosses.Zui.Projectiles
{
    internal class GoldBeamWarn : ModNPC
    {
        ...
        {
            Texture2D texture2D4 = Request<Texture2D>("Urdveil/Assets/NoiseTextures/Extra_47").Value;
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (NPC.ai[0] == 1)
                {
                    ...
                    if (Sound == 1)
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dreadmire__LightingRain1"), NPC.position);
                    }
                    if (Sound == 2)
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dreadmire__LightingRain2"), NPC.position);
                    }
                    if (Sound == 3)
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dreadmire__LightingRain3"), NPC.position);
