...
using Urdveil.Items.Weapons.Mage;
using Urdveil.Items.Weapons.Melee;
using Urdveil.Items.Weapons.Ranged;
using Urdveil.Items.Weapons.Summon;
using Urdveil.NPCs.Bosses.Verlia.Projectiles;
using Urdveil.NPCs.Bosses.Verlia.Projectiles.Sword;
using Urdveil.NPCs.Projectiles;
...
namespace Urdveil.NPCs.Bosses.Verlia
{
    ...
    public class VerliaB : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            drawModifiers.CustomTexturePath = "Urdveil/NPCs/Bosses/Verlia/VerliaPreview";
        ...
        private void SummonBeamer()
        {
            ...
            if (timer == 6)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/AbsoluteDistillence"));
            }
        ...
        private void StartSummonVerlia()
        {
            ...
            if (timer > 5)
            {
                if (timer == 6)
                {
                    if (StellaMultiplayer.IsHost)
                    {
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/SoftSummon"));
                ...
                if (timer == 54)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Huhhuh"));
                }
            }
        ...
        private void MoonStartSummonVerlia()
        {
            ...
            if (timer == 2)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/StarCharge"));
            }
            if (timer > 5)
            {
                if (timer == 6)
        ...
        private void BigSwordStartSummonVerlia()
        {
            ...
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/SoftSummon"));
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Moaning"));
                if (StellaMultiplayer.IsHost)
                {
                    float speedXb = NPC.velocity.X * Main.rand.NextFloat(0f, 0f) + Main.rand.NextFloat(0f, 0f);
                    float speedYb = NPC.velocity.Y * Main.rand.Next(0, 0) * 0.0f + Main.rand.Next(0, 0) * 0f;
            ...
            if (timer > 5)
            {
                if (timer == 10)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/SwordThrow"));
                }
        ...
        private void IdleSummonVerlia()
        {
            ...
            if (timer == 50)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/VerliaSONATO"));
            }
            if (timer == 200)
            {
                // We apply an initial velocity the first tick we are in the Jump frame. Remember that -Y is up.
        ...
        private void HoldUPVerlia()
        {
            ...
            if (timer == 2)
            {
                if (NPC.life < NPC.lifeMax / 2)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Sadano"));
        ...
        private void BarrageVerlia()
        {
            ...
            if (NPC.life < NPC.lifeMax / 2)
            {
                ...
                if (timer == 25)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/FrostShot2"));
                }
                ...
                if (timer == 45)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/FrostShot3"));
                }
                ...
                if (timer == 65)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/FrostShot1"));
                }
        ...
        private void ExplodeVerlia()
        {
            ...
            if (timer == 5)
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/VTeleportOut"));
                if (NPC.life < NPC.lifeMax / 2)
                {
                    if (StellaMultiplayer.IsHost)
                    {
        ...
        private void Verliasinsideme()
        {
            ...
            if (timer == 1)
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/VDisappear"));
        ...
        private void SwordUPVerlia()
        {
            ...
            if (timer == 4)
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/SwordSheethe"));
        ...
        private void SwordSimpleVerlia()
        {
            ...
            if (timer == 1)
            {
                if (player.Center.X > NPC.Center.X)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/SwordSlice"));
                }
                else
                {
                    if (StellaMultiplayer.IsHost)
        ...
        private void SwordHoldVerlia()
        {
            ...
            if (timer == 1)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Moaning"));
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/SwordHoldVerlia"));
            }
            if (timer < 30)
            {
