...
using Urdveil.Projectiles.Summons;
using Terraria;
...
namespace Urdveil.NPCs.Bosses.Verlia
{
    public class Bossdeath1 : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (Shooting == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/BiggerCharge"));
            ...
            if (bee2 == 0)
            {
                ...
                ActiveSound sound = SoundEngine.FindActiveSound(new SoundStyle("Urdveil/Assets/Sounds/BiggerCharge"));
                if (sound != null)
                {
                    sound.Stop();
                }

                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/NStarblast"));
