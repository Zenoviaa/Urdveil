...
namespace Urdveil.NPCs.Bosses.IrradiaNHavoc.Havoc.Projectiles
{
    internal class HavocLaserWarnProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/Extra_47").Value;
        ...
        {
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/StormDragon_Wave");
