...
using Urdveil.NPCs.Bosses.IrradiaNHavoc.Havoc.Projectiles;
...
namespace Urdveil.NPCs.Bosses.IrradiaNHavoc.Havoc
{
    ...
    internal class Havoc : ModNPC
    {
        ...
        //Textures
        public const string BaseTexturePath = "Urdveil/NPCs/Bosses/IrradiaNHavoc/Havoc/";
        ...
        private void AI_Charge()
        {
            ...
            else if (Timer < 180)
            {
                ...
                if (Timer == 151)
                {
                    SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/RekRoar");
        ...
        private void AI_Laser()
        {
            ...
            else if (AttackTimer == 3)
            {
                ...
                if (Timer == 1)
                {
                    SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/StormDragon_WaveCharge");
                    SoundEngine.PlaySound(soundStyle, NPC.position);
        ...
        private void AI_LaserBig()
        {
            ...
            if (AttackTimer == 0)
            {
                ...
                if (Timer == 1)
                {
                    SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/SingularityFragment_Charge2");
                    SoundEngine.PlaySound(soundStyle, NPC.position);
                }
            ...
            else if (AttackTimer == 1)
            {
                ...
                if (Timer == 1)
                {
                    SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/SingularityFragment_LAZER");
                    SoundEngine.PlaySound(soundStyle, NPC.position);
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            {
                Texture2D warningTexture = ModContent.Request<Texture2D>("Urdveil/NPCs/Bosses/IrradiaNHavoc/Havoc/Projectiles/HavocWarnChargeProj").Value;
                Player target = Main.player[NPC.target];
