...
using Urdveil.Items.Armors.Vanity.Gothivia;
...
using Urdveil.NPCs.Bosses.IrradiaNHavoc.Projectiles;
using System.IO;
using Terraria;
...
namespace Urdveil.NPCs.Bosses.IrradiaNHavoc.Irradia
{
    ...
    public class Irradia : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            drawModifiers.CustomTexturePath = "Urdveil/NPCs/Bosses/IrradiaNHavoc/Irradia/IrradiaBestiary";
        ...
        private void LandIrr()
        {
            ...
            if (timer == 49)
            {
                ...
                if (StellaMultiplayer.IsHost)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/BuildingSomething"), NPC.position);
                }
