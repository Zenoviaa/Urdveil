...
namespace Urdveil.NPCs.Bosses.EliteCommander.Projectiles
{
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                ...
                switch (Main.rand.Next(2))
                {
                    default:
                    case 0:
                        soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GladiatorMirage1");
                        break;
                    case 1:
                        soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GladiatorMirage2");
                        break;
                }
