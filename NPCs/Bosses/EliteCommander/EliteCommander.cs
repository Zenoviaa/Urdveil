...
namespace Urdveil.NPCs.Bosses.EliteCommander
{
    ...
    public class EliteCommander : BaseColosseumNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "Urdveil/NPCs/Event/Gintzearmy/BossGintze/GintziaPreview",
        ...
        private void AI_Land()
        {
            ...
            if (Timer == 1)
            {
                ...
                SoundStyle landingSound = new SoundStyle($"Urdveil/Assets/Sounds/Verifall");
