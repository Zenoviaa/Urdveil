...
namespace Urdveil.NPCs.Bosses.StarrVeriplant.Projectiles
{
    internal class SuperShockwave : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < Projectile.oldPos.Length; i++)
            {
                ...
                {
                    float p = (float)s / 8f;
                    Vector2 pos = Vector2.Lerp(oldPos, oldPos - Vector2.UnitY * 500 * totalP *
