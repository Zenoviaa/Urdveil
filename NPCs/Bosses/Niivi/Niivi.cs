...
using Urdveil.NPCs.Bosses.Niivi.Projectiles;
...
namespace Urdveil.NPCs.Bosses.Niivi
{
    internal class NiiviPlayer : ModPlayer
    {
        ...
        {
            if (!SkyManager.Instance["Urdveil:NiiviSky"].IsActive())
            {
                Vector2 targetCenter = Player.Center;
                SkyManager.Instance.Activate("Urdveil:NiiviSky", targetCenter);
        ...
        private void DeActivateSkye()
        {
            ...
            {
                Vector2 targetCenter = Player.Center;
                SkyManager.Instance.Deactivate("Urdveil:NiiviSky", targetCenter);
    ...
    internal partial class Niivi : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            drawModifiers.CustomTexturePath = "Urdveil/NPCs/Bosses/Niivi/NiiviPreview";
