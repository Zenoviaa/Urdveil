...
using Urdveil.NPCs.Bosses.GothiviaTheSun.REK.Projectiles;
...
namespace Urdveil.NPCs.Bosses.GothiviaTheSun.REK
{
    ...
    {
        //Draw Code
        private string BaseTexturePath => "Urdveil/NPCs/Bosses/GothiviaTheSun/REK/";
        ...
        public override void SetStaticDefaults()
        {
            ...
            drawModifiers.CustomTexturePath = "Urdveil/NPCs/Bosses/GothiviaTheSun/REK/RekBestiary";
        ...
        private void AI_Dash()
        {
            ...
            {
                NPC.TargetClosest();
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/HavocCharge"), NPC.position);
            ...
            if (Timer == 70)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SNAKEROAR"), NPC.position);
                StopSegmentGlow();
            }
        ...
        private void AI_Clappback()
        {
            ...
            if (Timer == 240)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/RekClappbackStart"), NPC.position);
            ...
            if (Timer == 300)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SNAKEROAR"), NPC.position);
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/RekShockwave"), NPC.position);
        ...
        private void AI_Ouroboros()
        {
            ...
            if (AttackCycle == 0)
            {
                ...
                if (AttackTimer < endSegment)
                {
                    ...
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/REKEAT"), NPC.position);
                        if (StellaMultiplayer.IsHost)
                        {
            ...
            else if (AttackCycle == 1)
            {
                ...
                if (AttackTimer == explosionTime)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/RekOuroborosExplosion"), NPC.Center);
                    float num = 8;
                    for (int i = 0; i < num; i++)
                    {
        ...
        private void AI_Death()
        {
            ...
            {
                //DIE NOWWWW!!!
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/RekDeath"), NPC.position);
