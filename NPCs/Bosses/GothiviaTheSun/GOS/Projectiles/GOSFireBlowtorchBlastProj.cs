...
namespace Urdveil.NPCs.Bosses.GothiviaTheSun.GOS.Projectiles
{
        ...
        IPixelPrimitiveDrawer
    {
        ...
        {
            Color c = Color.Lerp(Color.Orange, Color.RoyalBlue, completionRatio);
            if (Timer < LifeTime / 2)
            {
                c = Color.White;
                c *= 0.9f;
        ...
        public void DrawPixelPrimitives(SpriteBatch spriteBatch)
        {
            ...
            if (Timer < LifeTime / 2f)
            {
                ...
                Texture2D lineTexture = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/Extra_49").Value;
