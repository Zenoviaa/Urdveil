...
namespace Urdveil.NPCs.Bosses.GothiviaTheSun.GOS.Projectiles
{
    internal class WingRazor : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/GothExplode") { Pitch = Main.rand.NextFloat(-5f, 5f) }, Projectile.Center);
            var EntitySource = Projectile.GetSource_FromThis();
            float num = 8;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/DirnTrail").Value;
            var TrailTex2 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/DirnTrail").Value;
