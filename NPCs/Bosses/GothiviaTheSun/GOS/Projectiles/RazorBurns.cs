...
namespace Urdveil.NPCs.Bosses.GothiviaTheSun.GOS.Projectiles
{
    internal class RazorBurns : ModProjectile
    {
        ...
        private void AI_Collide()
        {
            ...
            for (int i = 0; i < Main.maxProjectiles; i++)
            {
                ...
                if (Projectile.Colliding(myRect, otherRect))
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/RazorClash") { Pitch = Main.rand.NextFloat(-5f, 5f) }, Projectile.Center);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WaterTrail").Value;
