...
namespace Urdveil.NPCs.Special
{
    internal abstract class BaseChest : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/StarFlower3"), NPC.position);
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/MorrowExp"), NPC.position);
