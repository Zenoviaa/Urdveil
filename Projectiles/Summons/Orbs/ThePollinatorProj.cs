    ...
    internal class ThePollinatorProj : OrbProjectile
    {
        ...
        private void Orbit()
        {
            ...
            if (ComboCounter >= 1)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Morrowarrow") { PitchVariance = 0.15f }, Projectile.position);
        ...
        private void Swing2()
        {
            ...
            if (Timer > SwingTime)
            {
                if (ComboCounter >= 1)
                {
                    ...
                    SoundEngine.PlaySound(soundStyle, Projectile.position);
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Morrowarrow") { PitchVariance = 0.15f, Pitch = -0.25f }, Projectile.position);
                    OrbHelper.PlaySummonSound(Projectile.position);
                    Reset();
                    SwingVelocity = Owner.DirectionTo(SwingTarget);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            switch (State)
            {
                ...
                case ActionState.Swing_2:
                    ...
                    soundStyle.PitchVariance = 0.15f;
                    SoundEngine.PlaySound(soundStyle, Projectile.position);
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/MorrowExp") { PitchVariance = 0.15f }, Projectile.position);
                    break;
                ...
                case ActionState.Swing_3:
                    ...
                    soundStyle.PitchVariance = 0.15f;
                    SoundEngine.PlaySound(soundStyle, Projectile.position);
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/OverGrowth_Thorn1") { PitchVariance = 0.15f }, Projectile.position);
                    break;
            }
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex2 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WhispyTrail").Value;
