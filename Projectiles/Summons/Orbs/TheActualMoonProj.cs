...
namespace Urdveil.Projectiles.Summons.Orbs
{
    internal class TheActualMoonProj : OrbProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            switch (State)
            {
                ...
                case ActionState.Swing_2:
                    ...
                    {
                        case 0:
                            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Astalaiya1") { PitchVariance = 0.15f }, Projectile.position);
                            break;
                        case 1:
                            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Astalaiya2") { PitchVariance = 0.15f }, Projectile.position);
                            break;
                        case 2:
                            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Astalaiya3") { PitchVariance = 0.15f }, Projectile.position);
                            break;
                    }
                    break;
                ...
                case ActionState.Swing_3:
                    ...
                    //Funny Screenshake
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/StarFlower3") { PitchVariance = 0.15f }, Projectile.position);
                    break;
            }
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex2 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/StringTrail").Value;
