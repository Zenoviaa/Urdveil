...
namespace Urdveil.Projectiles.Summons
{
    ...
    public class StarBoom : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                ...
                {
                    case 0:
                        morrowExp = new SoundStyle($"Urdveil/Assets/Sounds/StarFlower1");
                        break;
                    case 1:
                        morrowExp = new SoundStyle($"Urdveil/Assets/Sounds/StarFlower1");
                        break;
                    case 2:
                        morrowExp = new SoundStyle($"Urdveil/Assets/Sounds/StarFlower3");
                        break;
                }
