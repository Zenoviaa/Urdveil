...
namespace Urdveil.Projectiles.Summons.Minions
{
    ...
    public class VehementMinionProj : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            SoundStyle mySound = new SoundStyle("Urdveil/Assets/Sounds/Rhap1");
            if (Sound == 1)
            {
                mySound = new SoundStyle("Urdveil/Assets/Sounds/Rhap1");
            }
            if (Sound == 2)
            {
                mySound = new SoundStyle("Urdveil/Assets/Sounds/Rhap2");
            }
            if (Sound == 3)
            {
                mySound = new SoundStyle("Urdveil/Assets/Sounds/Rhap3");
        ...
        {
            Texture2D texture2D4 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/DimLight").Value;
