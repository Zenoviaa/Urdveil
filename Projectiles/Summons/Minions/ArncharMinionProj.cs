        ...
        public override void AI()
        {
            ...
            else if (foundTarget)
            {
                ...
                if (Timer > 30 && Timer % 10 == 0)
                {
                    ...
                    SoundStyle mySound = new SoundStyle("Urdveil/Assets/Sounds/ArcharilitDrone1");

                    if (Sound == 1)
                    {
                        mySound = new SoundStyle("Urdveil/Assets/Sounds/ArcharilitDrone1");
                    }
                    else
                    {
                        mySound = new SoundStyle("Urdveil/Assets/Sounds/ArcharilitDrone2");
                    }
