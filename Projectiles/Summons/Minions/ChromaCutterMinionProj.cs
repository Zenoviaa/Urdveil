...
namespace Urdveil.Projectiles.Summons.Minions
{
    internal class ChromaCutterMinionProj : ModProjectile
    {
        ...
        private void PlayShootSound()
        {
            ...
            {
                case 0:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Chroma3") with { PitchVariance = 0.1f }, Projectile.position);
                    break;
                case 1:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Chroma2") with { PitchVariance = 0.1f }, Projectile.position);
                    break;
                case 2:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Chroma1") with { PitchVariance = 0.1f }, Projectile.position);
                    break;
            }
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                case 0:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/AssassinsKnifeHit"), target.position);
                    break;
                case 1:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/AssassinsKnifeHit2"), target.position);
                    break;
            }
            ...
            switch (State)
            {
                ...
                case ActionState.Orange:
                    ...
                    SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Kaboom"));
                ...
                case ActionState.Cyan:
                    ...
                    {
                        case 0:
                            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/CyroBolt1"), target.position);
                            break;
                        case 1:
                            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/CyroBolt2"), target.position);
                            break;
                    }
                    break;
