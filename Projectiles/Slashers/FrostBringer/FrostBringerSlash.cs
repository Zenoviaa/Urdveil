...
using Urdveil.Projectiles.Slashers.Swords;
...
namespace Urdveil.Projectiles.Slashers.FrostBringer
{
    internal class FrostBringerSlash : BaseSwingProjectile
    {
        private bool _hasFired;
        public override string Texture => "Urdveil/Items/Weapons/Melee/FrostBringer";
        ...
        public override void SetSwingStyle(ref BaseSwingStyle swingStyle, int comboIndex)
        {
            ...
            {
                case 0:
                    SoundStyle swingSound = new SoundStyle("Urdveil/Assets/Sounds/NormalSwordSlash2");
