...
namespace Urdveil.Projectiles.Slashers.Chillrend
{
    public class ChillrendProj2 : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex3 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WhispyTrail").Value;
            var TrailTex4 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/StarTrail").Value;
