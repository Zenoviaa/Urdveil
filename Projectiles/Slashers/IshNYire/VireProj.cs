...
namespace Urdveil.Projectiles.Slashers.IshNYire
{
    public class VireProj : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle($"{nameof(Urdveil)}/Assets/Sounds/MorrowExp"));
            ...
            if (Slam)
            {
				...
				*/
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Vinger2"));
            ...
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Vinger"));
                ShakeModSystem.Shake = 4;
                for (int i = 0; i < 14; i++)
                {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WhispyTrail").Value;
