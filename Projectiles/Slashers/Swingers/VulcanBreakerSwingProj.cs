...
namespace Urdveil.Projectiles.Slashers.Swingers
{
    internal class VulcanBreakerSwingProj : ModProjectile
    {
        public override string Texture => "Urdveil/Items/Weapons/Melee/VulcanBreaker";
        //DrawCode
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tipSlashTexture = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/TerraTrail").Value;
            if (SwordSlash == null)
            {
