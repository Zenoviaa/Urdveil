...
using Urdveil.Projectiles.Ammo;
using Terraria;
        ...
        public override void AI()
        {
            ...
            if (npc != null)
            {
                ...
                if (Timer > 92)
                {
                    ...
                    if (Sound == 1)
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/GraniteMagmum1") { PitchVariance = 0.15f }, Projectile.position);
                    }
                    else
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/GraniteMagmum2") { PitchVariance = 0.15f }, Projectile.position);
                    }
                    Timer = 0;
                }
            }
