...
namespace Urdveil.Projectiles
{
    internal class BrackettThrough : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] == 1)
            {
                ...
                if (A == 0)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Saw1"), Projectile.position);
                }
                else
                {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D4 = Request<Texture2D>("Urdveil/Assets/NoiseTextures/Spiin").Value;
