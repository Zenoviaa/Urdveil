...
namespace Urdveil.Projectiles.GunHolster
{
    internal class NLUX : ModProjectile,
        IPixelPrimitiveDrawer
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    Dust.NewDustPerfect(explosionCenter, ModContent.DustType<GlowDust>(), (Vector2.One * Main.rand.NextFloat(0.00f, 1.00f)).RotatedByRandom(19.0), 0, Color.Turquoise, 1f).noGravity = true;
                }
            }
        }
