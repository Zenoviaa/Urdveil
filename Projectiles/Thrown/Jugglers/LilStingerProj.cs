    ...
    internal class LilStingerProj : ModProjectile
    {
        ...
        private void AI_Fall()
        {
            ...
            if (IsTouchingPlayer())
            {
                ...
                SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/JuggleCatch1");
                ...
                switch (Main.rand.Next(2))
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        soundStyle = new SoundStyle("Urdveil/Assets/Sounds/JuggleCatch2");
                        SoundEngine.PlaySound(soundStyle, Projectile.position);
                        break;
                }
            ...
            if (Timer >= 598)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dirt"), Projectile.position);
                Juggler.ResetJuggle();
                Projectile.Kill();
            }
        }
