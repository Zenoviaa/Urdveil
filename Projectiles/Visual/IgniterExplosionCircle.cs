...
namespace Urdveil.Projectiles.Visual
{
        ...
        IPixelPrimitiveDrawer
    {
        ...
        //Radius
        public float StartRadius { get; set; } = 4;
        public float EndRadius { get; set; } = 64;
        public float Width { get; set; } = 24;

        //Colors
        public Color DrawColor { get; set; } = Color.White;
        private Color FrontCircleStartDrawColor => DrawColor;
        private Color FrontCircleEndDrawColor => DrawColor;
        private Color BackCircleStartDrawColor => Color.Lerp(DrawColor, Color.Black, 0.4f);
        private Color BackCircleEndDrawColor => Color.Lerp(DrawColor, Color.Black, 0.7f);
