...
{
    internal class SmallShieldCircleExplosionProj : ModProjectile,
        IPixelPrimitiveDrawer
    {
        ...
        private Color BackCircleStartDrawColor => Color.Lerp(Color.White, Color.LightGray, 0.4f);
        private Color BackCircleEndDrawColor => Color.Lerp(Color.LightGray, Color.DarkGray, 0.7f);
