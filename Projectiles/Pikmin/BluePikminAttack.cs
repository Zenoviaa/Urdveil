...
namespace Urdveil.Projectiles.Pikmin
{
    internal class BluePikminAttack : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Attacktime >= 20)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Pikminhit1") with { Volume = 0.4f });
                        break;

                    case 1:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Pikminhit2") with { Volume = 0.4f });
                        break;

                    case 2:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Pikminhit3") with { Volume = 0.4f });
                        break;

                    case 3:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Pikminhit4") with { Volume = 0.4f });
                        break;

                    case 4:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Pikminhit5") with { Volume = 0.4f });
                        break;
