...
namespace Urdveil.Projectiles.Gun
{
    internal class RustedSnipe : ModProjectile, IPixelPrimitiveDrawer
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                case 0:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/AssassinsKnifeHit"));
                    break;
                case 1:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/AssassinsKnifeHit2"));
                    break;
            }
        }
