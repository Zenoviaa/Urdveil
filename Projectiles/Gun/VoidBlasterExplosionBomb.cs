    ...
    public class VoidBlasterExplosionBomb : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Vinger2"), Projectile.position);
                for (int i = 0; i < 14; i++)
                {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Vinger"), Projectile.position);
                ShakeModSystem.Shake = 4;
                for (int i = 0; i < 6; i++)
                {
