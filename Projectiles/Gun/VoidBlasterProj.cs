...
namespace Urdveil.Projectiles.Gun
{
    ...
    public class VoidBlasterProj : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            else
            {
                ...
                if (voidBlasterPlayer.hitCount >= 6)
                {
                    ...
                    if (Sound == 1)
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/VoidBlasterExplosionBomb"), Projectile.position);
                    }
                    else
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/VoidBlasterExplosionBomb2"), Projectile.position);
                    }
                }
            }
        }
        public override void OnSpawn(IEntitySource source)
        {
            ...
            if (Sound == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/VoidBlaster2"), Projectile.position);
            }
            else
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/VoidBlaster1"), Projectile.position);
            }
        }
