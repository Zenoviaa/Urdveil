    ...
    public class DeathShotBomb : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 2)
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/DeathShotBomb"), Projectile.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/DeathShotBomb2"), Projectile.position);
                }
                for (int i = 0; i < 14; i++)
                {
