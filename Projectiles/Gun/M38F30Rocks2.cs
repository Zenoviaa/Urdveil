...
namespace Urdveil.Projectiles.Gun
{
    internal class M38F30Rocks2 : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Sound == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/M38F30Bomb3"), Projectile.position);
            }
            else
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/M38F30Bomb4"), Projectile.position);
            }
            for (int i = 0; i < 10; i++)
            {
