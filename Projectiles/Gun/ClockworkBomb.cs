...
namespace Urdveil.Projectiles.Gun
{
    public class ClockworkBoomer : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 10)
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/ClockworkCity1"), Projectile.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/ClockworkCity2"), Projectile.position);
                }
    ...
    internal class ClockworkBomb : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/DimLight").Value;
            for (int i = 0; i < 6; i++)
            {
