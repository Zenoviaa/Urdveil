...
namespace Urdveil.Projectiles.Magic
{
    internal class PericarditisProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Pericarditis"), Projectile.position);
            }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Sound == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dreadmire_BoneSpawn1"), Projectile.position);
            }
            else
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dreadmire_BoneSpawn2"), Projectile.position);
            }
