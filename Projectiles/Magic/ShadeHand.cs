    ...
    internal class ShadeHand : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!Moved && Projectile.ai[1] >= 0)
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/ShadeHand"), Projectile.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/ShadeHand2"), Projectile.position);
                }
