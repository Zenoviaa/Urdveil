    ...
    internal class SunDeathG : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SunStalker_Sun_Shot2"), Projectile.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SunStalker_Sun_Shot1"), Projectile.position);
                }
