...
using Urdveil.Common.MaskingShaderSystem;
          ...
          IDrawMaskShader
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 10)
            {
                ...
                SoundStyle explodeStyle = new SoundStyle("Urdveil/Assets/Sounds/STARGROP");
        ...
        {
            //Use the defaults
            var shaderData = GameShaders.Misc["Urdveil:SimpleDistortion"];
