    ...
    public class AcidFlameG : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 1)
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Irradieagle_Flare1"), Projectile.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Irradieagle_Flare2"), Projectile.position);
                }
            }
            Projectile.spriteDirection = Projectile.direction;
