...
namespace Urdveil.Projectiles.Magic
{
    internal class VoidHandSpawn : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/VoidHand"), Projectile.position);
            ...
            if (Timer == 40)
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/VoidHand3"), Projectile.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/VoidHand2"), Projectile.position);
                }
