    ...
    internal class CombusterSparkProj2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/CombusterSnap") with { PitchVariance = 0.15f });
            }

            if (Timer == 45)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/CombusterReady"));
            }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Kaboom"), Projectile.position);
