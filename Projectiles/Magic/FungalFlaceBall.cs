    ...
    internal class FungalFlaceBall : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] <= 3)
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/FungalFlaceBall1"), Projectile.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/FungalFlaceBall2"), Projectile.position);
                }
            }
            Projectile.ai[1]++;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Sound == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/FungalFlaceBall3"), Projectile.position);
            }
            else
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/FungalFlaceBall4"), Projectile.position);
            }
