    ...
    public class RhamenthalProjHold : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer > 75)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/CyroBolt2"), Projectile.position);
                Timer = 0;
            }
            ...
            if (Timer == 1)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/CorsageRune1"), Projectile.position);
            }
            ...
            if (Timer == 75)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Rhamenthal"), Projectile.position);
