...
namespace Urdveil.Projectiles.Bow
{
    ...
    {
        public override string Texture => "Urdveil/Items/Weapons/Ranged/PenetratorMiracle";
        Vector2 HoldOffset;
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                ...
                SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/CrossbowPull");
            ...
            if (Timer == 44)
            {
                SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/SoftSummon");
                soundStyle.PitchVariance = 0.15f;
                soundStyle.Pitch = -0.75f;
                SoundEngine.PlaySound(soundStyle);
            }
            ...
            if (Timer == 50)
            {
                ...
                SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GallinLock2");
                soundStyle.PitchVariance = 0.15f;
