...
namespace Urdveil.Projectiles.Bow
{
    internal class CrysalizerArrow2 : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                case 0:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Crysalizer1"), Projectile.position);
                    break;
                case 1:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Crysalizer2"), Projectile.position);
                    break;
                case 2:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Crysalizer3"), Projectile.position);
                    break;
                case 3:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Crysalizer4"), Projectile.position);
                    break;
            }
