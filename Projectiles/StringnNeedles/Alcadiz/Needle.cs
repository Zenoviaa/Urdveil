...
namespace Urdveil.Projectiles.StringnNeedles.Alcadiz
{
    public class Needle : ModProjectile
    {
        ...
        {
            ProjectileExtras.DrawChain(Projectile.whoAmI, Main.player[Projectile.owner].MountedCenter, "Urdveil/Projectiles/StringnNeedles/Alcadiz/Needle_Chain");
