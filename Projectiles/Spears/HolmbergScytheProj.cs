        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] == 5 || Projectile.ai[1] == 10)
            {
                ...
                if (Main.rand.NextBool(8))
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Scything2"), Projectile.position);
                }
                else
                {
                    ...
                    if (Sound == 1)
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Scything3"), Projectile.position);
                    }
                    else
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Scything1"), Projectile.position);
                    }
