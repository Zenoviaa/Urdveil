...
namespace Urdveil.Projectiles.Spears
{
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] == 5 || Projectile.ai[1] == 10 || Projectile.ai[1] == 15 || Projectile.ai[1] == 20)
            {
                ...
                if (Main.rand.NextBool(8))
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/GladiatorMirageRed"), Projectile.position);
                }
                else
                {
                    ...
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/GladiatorMirage2"), Projectile.position);
                    }
