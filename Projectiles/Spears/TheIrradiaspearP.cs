...
namespace Urdveil.Projectiles.Spears
{
    internal class TheIrradiaspearP : ModProjectile
    {
        ...
        private void AI_Charge()
        {
            ...
            if (Timer == ChargeTime)
            {
                SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/IrradiatedNest_Teleport");
        ...
        private void AI_Out()
        {
            ...
            {
                //Throw Sound
                SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/IrradiatedNest_Egg_Shot");
                SoundEngine.PlaySound(soundStyle, Projectile.position);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                //Big impact sound
                SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/Irradieagle_Wave");
                SoundEngine.PlaySound(soundStyle, Projectile.position);
