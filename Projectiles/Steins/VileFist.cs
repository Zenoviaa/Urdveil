    ...
    public class VileFist : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (!bounced)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dreadmire_BoneSpawn1") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Dreadmire__Skulls"), Projectile.Center);
                        break;
                    case 1:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dreadmire_Fire1") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Dreadmire__Skulls"), Projectile.Center);
                        break;
                    case 2:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dreadmire__LightingRain2") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Dreadmire__Skulls"), Projectile.Center);
                        break;
