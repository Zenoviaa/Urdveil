...
using Urdveil.Projectiles.IgniterExplosions.Stein;
...
namespace Urdveil.Projectiles.Steins
{
    public class GothFist : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (!bounced)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SteinGoth") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });
                switch (Main.rand.Next(7))
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/GoldenSlice1") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });

                        break;
                    case 1:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/GoldenSlice2") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });

                        break;
                    case 2:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/GoldenSlice3") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });

                        break;

                    case 3:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SteinIk") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });

                        break;

                    case 4:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SteinHulting") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });

                        break;

                    case 5:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SteinShading") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });

                        break;

                    case 6:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SteinVolting") { Pitch = Main.rand.NextFloat(-0.5f, 0.5f) });
                ...
                switch (Main.rand.Next(3))
                {
                    case 0:
                        ...
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Steinhit1"), Projectile.Center);
                        break;
                    case 1:

                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Steinhit2"), Projectile.Center);
                        break;
                    case 2:

                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Steinhit3"), Projectile.Center);
                        break;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/SkiTrail").Value;
            var TrailTex2 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WaterTrail").Value;
            var TrailTex3 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WaterTrail").Value;
            var TrailTex4 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/SkiTrail").Value;
