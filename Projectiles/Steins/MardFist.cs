...
namespace Urdveil.Projectiles.Steins
{
    public class MardFist : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WhiteTrail").Value;
            var TrailTex2 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WhiteTrail").Value;
            var TrailTex3 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/CrystalTrail").Value;
            var TrailTex4 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/CrystalTrail").Value;
