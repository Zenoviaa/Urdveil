...
namespace Urdveil.Projectiles.Steins
{
    public class IkFist : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/CausticTrail").Value;
            var TrailTex2 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/CausticTrail").Value;
            var TrailTex3 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WhiteTrail").Value;
