...
namespace Urdveil.Projectiles.Steins
{
    public class FriedFist : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/DirmTrail").Value;
            var TrailTex2 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WaterTrail").Value;
            var TrailTex3 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/CrystalTrail").Value;
            var TrailTex4 = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/WhiteTrail").Value;
