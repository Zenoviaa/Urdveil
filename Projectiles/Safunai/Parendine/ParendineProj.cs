...
namespace Urdveil.Projectiles.Safunai.Parendine
{
    public class ParendineProj : BaseSafunaiProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (Slam)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Parendine"));
                for (int i = 0; i < 14; i++)
                {
            ...
            else
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Parendine2"));
