...
namespace Urdveil.Projectiles.Crossbows.Lasers
{
    public class TheTraumatizerHold : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer % 20 == 0)
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/TraumatizerLaserFire") with { PitchVariance = 0.1f }, Projectile.position);
            ...
            if (Timer < 3)
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/TraumatizerLaserStart"));
            }
