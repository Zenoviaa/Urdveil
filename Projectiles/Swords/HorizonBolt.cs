    ...
    public class HorizonBolt : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] == 1)
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/EventHorizon1"), Projectile.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/EventHorizon2"), Projectile.position);
                }
            }
        }
