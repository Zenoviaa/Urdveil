...
namespace Urdveil.Projectiles.Swords
{
    public class WindSytheBlue : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SkyrageShasher"), Projectile.position);
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SkyrageShasherEle"), Projectile.position);
            }
