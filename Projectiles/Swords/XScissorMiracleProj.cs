...
namespace Urdveil.Projectiles.Swords
{
    ...
    {
        private bool _init;
        public override string Texture => "Urdveil/Items/Weapons/Melee/XScissorMiracle";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/VoidHit");
       ...
       0, 0, Projectile.owner);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/VortexTrail").Value;
