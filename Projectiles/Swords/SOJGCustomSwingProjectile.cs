...
namespace Urdveil.Projectiles.Swords
{
    ...
    {
        private bool _init;
        public override string Texture => "Urdveil/Items/Weapons/Melee/SwordOfTheJungleGoddess";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/BulbTrail").Value;
