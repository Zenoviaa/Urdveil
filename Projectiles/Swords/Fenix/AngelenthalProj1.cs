    ...
    public class AngelenthalProj1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (death == 5)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SwordSlice"), Projectile.position);
            ...
            if (death == 65)
            {
                ...
                p.rotation = direction.ToRotation();
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SwordOfGlactia2"), Projectile.position);
