...
namespace Urdveil.Projectiles.Swords.Fenix
{
    ...
    internal class AngelenthalThrow : ModProjectile
    {
        ...
        {
            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Infernis1"), Projectile.position);

            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Binding_Abyss_Rune"), Projectile.position);
