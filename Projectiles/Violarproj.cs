        ...
        public override void AI()
        {
            Projectile.velocity *= 0.98f;
            {
                ...
                if (Timer == 150)
                {
                    ...
                    if (S1 == 0)
                    {
                        SoundEngine.PlaySound(new SoundStyle($"{nameof(Urdveil)}/Assets/Sounds/MorrowSong"), Projectile.position);
                    }
                    if (S1 == 1)
                    {
                        SoundEngine.PlaySound(new SoundStyle($"{nameof(Urdveil)}/Assets/Sounds/MorrowSong2"), Projectile.position);
                    }
                    if (S1 == 2)
                    {
                        SoundEngine.PlaySound(new SoundStyle($"{nameof(Urdveil)}/Assets/Sounds/MorrowSong3"), Projectile.position);
                    }
                    ...
                    Projectile.Kill();
                    SoundEngine.PlaySound(new SoundStyle($"{nameof(Urdveil)}/Assets/Sounds/MorrowExp"), Projectile.position);
                    Timer = 0;
                }
                if (Timer >= 100)
                {
