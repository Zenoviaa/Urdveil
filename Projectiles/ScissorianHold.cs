    ...
    public class ScissorianHold : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 13)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Binding_Abyss_Rune_SoulStar"));
                        break;

                    case 1:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Binding_Abyss_Rune"));
                        break;

                    case 2:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/FrostBringer"));
                        break;
            ...
            if (Timer == 24)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Crysalizer3"));
                        break;

                    case 1:
                        SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/WinterStorm2"));
                        break;
