...
{
    internal class WindBoomFriendly : BaseWindProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                SoundStyle windHit = new SoundStyle($"Urdveil/Assets/Sounds/WindHit", variantSuffixesStart: 1, numVariants: 2);
