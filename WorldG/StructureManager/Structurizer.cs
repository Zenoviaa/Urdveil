...
namespace Urdveil.WorldG.StructureManager
{
    ...
    public static class Structurizer
    {
        ...
        static Mod Mod = ModContent.GetInstance<Urdveil>();
    ...
    {
        public override string Texture => "Urdveil/WorldG/StructureManager/WandSaver"; //I do not do spriting
    ...
    {
        public override string Texture => "Urdveil/WorldG/StructureManager/Modelizer"; //I do not do spriting
        public override void SetDefaults()
        {
            Item.CloneDefaults(ItemID.MagicConch);
            Item.useTime = Item.useAnimation = 15;
