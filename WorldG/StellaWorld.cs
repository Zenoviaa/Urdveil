...
//using Urdveil.Items.Accessories.AlcadChests;
//using Urdveil.Items.Accessories.Brooches;
//using Urdveil.Items.Armors.Alcalite;
//using Urdveil.Items.Armors.Stone;
//using Urdveil.Items.Armors.Windmillion;
//using Urdveil.Items.Consumables;
//using Urdveil.Items.Flasks;
//using Urdveil.Items.Harvesting;
//using Urdveil.Items.Materials;
//using Urdveil.Items.Materials.Tech;
//using Urdveil.Items.Ores;
//using Urdveil.Items.Quest.Merena;
//using Urdveil.Items.Special.MinerLogs;
//using Urdveil.Items.Tools;
...
//using Urdveil.Items.Weapons.Melee.Spears;
//using Urdveil.Items.Weapons.PowdersItem;
//using Urdveil.Items.Weapons.Ranged;
//using Urdveil.Items.Weapons.Ranged.Crossbows;
...
//                        case 2:
//                            itemsToAdd.Add((ModContent.ItemType<WindedQuiver>(), genRand.Next(1, 1)));
//                            break;
...
//                for (int da = 0; da < 1; da++)
//                {
//                    Point Loc = new Point(smx - 270, smyy - 70);
