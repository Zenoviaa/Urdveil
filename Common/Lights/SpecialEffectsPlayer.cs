...
namespace Urdveil.Common.Lights
{
    internal class SpecialEffectsPlayer : ModPlayer
    {
        ...
        private string DarknessVignette => "Urdveil:DarknessVignette";
        ...
        private void SpecialBiomeEffects()
        {
            ...
            screenShaderData = FilterManager["Urdveil:PaletteAbyss"].GetShader();
            screenShaderData.UseProgress(abyssPaletteProgress);
            TogglePaletteShader("Urdveil:PaletteAbyss", abyssPaletteProgress != 0);
            ...
            screenShaderData = FilterManager["Urdveil:PaletteVirulent"].GetShader();
            screenShaderData.UseProgress(rustyPaletteProgress);
            TogglePaletteShader("Urdveil:PaletteVirulent", rustyPaletteProgress != 0);
            ...
            screenShaderData = FilterManager["Urdveil:PaletteHell"].GetShader();
            screenShaderData.UseProgress(hellPaletteProgress);
            TogglePaletteShader("Urdveil:PaletteHell", hellPaletteProgress != 0);
            ...
            screenShaderData = FilterManager["Urdveil:PaletteRoyalCapital"].GetShader();
            screenShaderData.UseProgress(royalPaletteProgress);
            TogglePaletteShader("Urdveil:PaletteRoyalCapital", royalPaletteProgress != 0);
            ...
            screenShaderData = FilterManager["Urdveil:PaletteDungeon"].GetShader();
            screenShaderData.UseProgress(dungeonPaletteProgress);
            TogglePaletteShader("Urdveil:PaletteDungeon", dungeonPaletteProgress != 0);
            ...
            screenShaderData = FilterManager["Urdveil:PaletteDesert"].GetShader();
            screenShaderData.UseProgress(desertPaletteProgress);
            TogglePaletteShader("Urdveil:PaletteDesert", desertPaletteProgress != 0);
            ...
            screenShaderData = FilterManager["Urdveil:PaletteDesertTop"].GetShader();
            screenShaderData.UseProgress(desertTopPaletteProgress);
            TogglePaletteShader("Urdveil:PaletteDesertTop", desertTopPaletteProgress != 0);
            ...
            screenShaderData = FilterManager["Urdveil:PaletteBloodHound"].GetShader();
            screenShaderData.UseProgress(bloodCathedralPaletteProgress);
            TogglePaletteShader("Urdveil:PaletteBloodHound", bloodCathedralPaletteProgress != 0);

            CalculateDarkness();
            TogglePaletteShader("Urdveil:DarknessVignette", darkness != 0);
            ...
            screenShaderData = FilterManager["Urdveil:DarknessCurve"].GetShader();
            ...
            TogglePaletteShader("Urdveil:DarknessCurve", darknessCurve != 0);
            ...
            screenShaderData = FilterManager["Urdveil:Blur"].GetShader();
            screenShaderData.UseProgress(blurStrength * _blurLerp);
            TogglePaletteShader("Urdveil:Blur", blurActive);
            ...
            screenShaderData = FilterManager["Urdveil:BlackWhite"].GetShader();
            ...
            TogglePaletteShader("Urdveil:BlackWhite", _blackWhiteLerp != 0);
