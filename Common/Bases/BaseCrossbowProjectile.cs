...
namespace Urdveil.Common.Bases
{
    internal abstract class BaseCrossbowProjectile : ModProjectile
    {
        ...
        public virtual void AI_TakeAim()
        {
            ...
            if (Timer == 1)
            {
                SoundStyle crossbowPull = new SoundStyle("Urdveil/Assets/Sounds/CrossbowPull");
        ...
        public virtual void AI_AimFire()
        {
            ...
            if (Timer == 1)
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/MorrowSalfi"), Projectile.position);
        ...
        public void DrawAimingLines(ref Color lightColor)
        {
            ...
            if (heldItem.ModItem == null)
                return;
            Asset<Texture2D> heldTexture = ModContent.Request<Texture2D>("Urdveil/Common/Bases/CrossbowCrosshairLineParticle");
      ...
      aimLineOrigin, 1f, SpriteEffects.None, 0);
        ...
        public void DrawCrosshair(ref Color lightColor)
        {
            ...
            SpriteBatch spriteBatch = Main.spriteBatch;
            Asset<Texture2D> tex = ModContent.Request<Texture2D>("Urdveil/Common/Bases/CrossbowCrosshair");
