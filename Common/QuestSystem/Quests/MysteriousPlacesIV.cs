...
{
    internal class MysteriousPlacesIV : Quest
    {
        ...
        public override bool CanGiveQuest(Player player)
        {
            ...
            return questPlayer.HasFinishedQuest(QuestLoader.GetInstance<MysteriousPlacesIII>());
        }
        ...
        {
            return player.GetModPlayer<MyPlayer>().ZoneBloodCathedral;
        }
