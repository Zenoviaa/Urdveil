...
namespace Urdveil.Assets.Biomes
{
    ...
    public class CathedralBiome : ModBiome
    {
        ...
        public override ModWaterStyle WaterStyle => ModContent.Find<ModWaterStyle>("Urdveil/CathedralWaterStyle"); // Sets a water style for when inside this biome
        public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.Find<ModSurfaceBackgroundStyle>("Urdveil/CathedralBackgroundStyle");
        ...
        public override void SpecialVisuals(Player player, bool isActive)
        {
            ...
            //   if (!SkyManager.Instance["Urdveil:NaxtrinSky"].IsActive() && isActive)
            //		SkyManager.Instance.Activate("Urdveil:NaxtrinSky", player.Center);
            //	if (SkyManager.Instance["Urdveil:NaxtrinSky"].IsActive() && !isActive)
            //		SkyManager.Instance.Deactivate("Urdveil:NaxtrinSky");
        }
