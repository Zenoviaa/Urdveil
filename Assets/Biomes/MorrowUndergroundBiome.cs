...
namespace Urdveil.Assets.Biomes
{
    public class MorrowUndergroundBiome : ModBiome
    {
        ...
        public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.Find<ModUndergroundBackgroundStyle>("Urdveil/MorrowUndergroundBackgroundStyle");
