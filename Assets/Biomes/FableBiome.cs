...
namespace Urdveil.Assets.Biomes
{
    ...
    public class FableBiome : ModBiome
    {
        ...
        public override ModWaterStyle WaterStyle => ModContent.Find<ModWaterStyle>("Urdveil/IshtarWaterStyle"); // Sets a water style for when inside this biome
        public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.Find<ModSurfaceBackgroundStyle>("Urdveil/FabledBackgroundStyle");
