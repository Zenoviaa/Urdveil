...
namespace Urdveil.Assets.Biomes
{
    public class SeaTemple : ModBiome
    {
        ...
        public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.Find<ModUndergroundBackgroundStyle>("Urdveil/SeaTempleBackgroundStyle");
