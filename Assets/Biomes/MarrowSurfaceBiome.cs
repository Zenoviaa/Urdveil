...
namespace Urdveil.Assets.Biomes
{
    ...
    public class MarrowSurfaceBiome : ModBiome
    {
        ...
        public override ModWaterStyle WaterStyle => ModContent.Find<ModWaterStyle>("Urdveil/MarrowWaterStyle"); // Sets a water style for when inside this biome
        public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.Find<ModSurfaceBackgroundStyle>("Urdveil/MarrowSurfaceBackgroundStyle");
