...
namespace Urdveil.Assets.Biomes
{
    ...
    public class VeilBiome : ModBiome
    {
        ...
        public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.Find<ModSurfaceBackgroundStyle>("Urdveil/VeilBackgroundStyle");
		...
		public override void SpecialVisuals(Player player, bool isActive)
		{
			...
			if (!SkyManager.Instance["Urdveil:VillageSky"].IsActive() && isActive)
				SkyManager.Instance.Activate("Urdveil:VillageSky", player.Center);
			if (SkyManager.Instance["Urdveil:VillageSky"].IsActive() && !isActive)
				SkyManager.Instance.Deactivate("Urdveil:VillageSky");
