...
using Urdveil.Items.Placeable.Cathedral;
...
namespace Urdveil.Tiles.Structures.Cathedral
{
    ...
    public class VerliasShrine : ModTile
    {
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("Urdveil/Particles/GradientPillar").Value;
