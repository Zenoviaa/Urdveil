...
using Urdveil.Buffs;
using Urdveil.Buffs.Minions;
using Urdveil.Dusts;
using Urdveil.Gores.Foreground;
using Urdveil.Helpers;
using Urdveil.Items.Accessories.PicturePerfect;
using Urdveil.Items.Accessories.Runes;
using Urdveil.Items.Armors.Alsis;
using Urdveil.Items.Armors.Artisan;
using Urdveil.Items.Armors.Daedia;
using Urdveil.Items.Armors.Ducanblitz;
using Urdveil.Items.Armors.Govheil;
using Urdveil.Items.Armors.Lovestruck;
using Urdveil.Items.Armors.Terric;
using Urdveil.Items.Armors.Verl;
using Urdveil.Items.Special.Sirestias;
using Urdveil.Items.Weapons.Melee;
using Urdveil.NPCs.Bosses.Verlia;
using Urdveil.Projectiles;
using Urdveil.Projectiles.Ambient;
using Urdveil.Projectiles.Paint;
using Urdveil.Projectiles.Summons.Minions;
using Urdveil.Projectiles.Swords;
...
namespace Urdveil
{
    ...
    public class MyPlayer : ModPlayer
    {
        ...
        public override void ModifyHurt(ref Player.HurtModifiers modifiers)/* tModPorter Override ImmuneTo, FreeDodge or ConsumableDodge instead to prevent taking damage */
        {
            if (WindRune && !Player.HasBuff(ModContent.BuffType<GintzelSheildCD>()) && !Player.HasBuff(ModContent.BuffType<GintzelSheild>()))
            {
                ...
                if (Main.rand.NextBool(3))
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Verispin"), Player.position);
            ...
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/StealthRune"), Player.position);
                for (int m = 0; m < 20; m++)
                {
            ...
            if (CorsageRune && CorsageTime == 0)
            {
                ...
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/CorsageRune1"), Player.position);
                    for (int i = 0; i < 20; i++)
                    {
                        var entitySource = Player.GetSource_FromThis();
            ...
            if (CorsageTime >= 1 && CorsageRune)
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/CorsageRune2"), Player.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/CorsageRune3"), Player.position);
                }
                for (int i = 0; i < 200; i++)
                {
        ...
        public override void PostUpdateMiscEffects()
        {
            ...
            //     base.Player.ManageSpecialBiomeVisuals("Urdveil:GreenSunSky", EventWorld.GreenSun && ZoneAcid);

            // base.Player.ManageSpecialBiomeVisuals("Urdveil:ChaosD", EventWorld.ChaosD && Player.ZoneBeach);
            base.Player.ManageSpecialBiomeVisuals("Urdveil:Veil", ZoneVeil);

            //base.Player.ManageSpecialBiomeVisuals("Urdveil:Starbloom", EventWorld.Aurorean && (Player.ZoneOverworldHeight || Player.ZoneSkyHeight));
            //base.Player.ManageSpecialBiomeVisuals("Urdveil:Aurelus", ZoneAurelus);
            base.Player.ManageSpecialBiomeVisuals("Urdveil:Illuria", ZoneIlluria);
        ...
        public override void PostUpdate()
        {
            ...
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SwordSlice"), Player.position);
                WindRuneOn = false;
            ...
            if (Cameraaa)
            {
                ...
                if (CameraaaTime <= 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/DMHeart__Vomit3"), player.position);
                    var EntitySource = Player.GetSource_FromThis();
            ...
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Arcaneup"));
                for (int j = 0; j < 1; j++)
                {
            ...
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Three"));
                for (int j = 0; j < 5; j++)
                {
            ...
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Two"));
                for (int j = 0; j < 5; j++)
                {
                    Vector2 speed = Main.rand.NextVector2Circular(1f, 1f);
            ...
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/One"));
                for (int j = 0; j < 5; j++)
                {
                    Vector2 speed = Main.rand.NextVector2Circular(1f, 1f);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center, speed * 5, ModContent.ProjectileType<Paint2>(), 25, 1f, Player.whoAmI);
            ...
            {
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/zero"));
                SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Binding_Abyss_Spawn"));
                for (int j = 0; j < 5; j++)
                {
                    Vector2 speed = Main.rand.NextVector2Circular(1f, 1f);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center, speed * 5, ModContent.ProjectileType<Paint3>(), 25, 1f, Player.whoAmI);
            ...
            {
                if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true)
                {
                    for (int j = 0; j < 1; j++)
                    {
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true && ZoneMechanics)
            {
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true && !Main.dayTime && (ZoneFable || ZoneMorrow))
            {
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true && (ZoneAcid || ZoneGovheil || ZoneVeri) && !ZoneLab)
            {
                Main.windPhysicsStrength = 90;
                Main.GraveyardVisualIntensity = 0.4f;
                GoldenRingCooldown++;
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true && ZoneVillage)
            {
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true && ZoneVeil)
            {
                Main.GraveyardVisualIntensity = 0.1f;
                Main.windPhysicsStrength = 50;
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().VanillaParticlesToggle == true && Player.ZoneHallow)
            {
                Main.GraveyardVisualIntensity = 0.4f;
                Main.windPhysicsStrength = 50;
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true && ZoneAlcadzia)
            {
                Main.windPhysicsStrength = 90;
                Main.GraveyardVisualIntensity = 0.4f;
                GoldenRingCooldown++;
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true && (ZoneAbyss || ZoneAurelus || ZoneIlluria))
            {
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true && spawnAuroreanParticles)
            {
                Main.windPhysicsStrength = 50;
                GoldenRingCooldown++;
                GoldenSparkleCooldown++;
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true && spawnAuroreanParticles2)
            {
                Main.windPhysicsStrength = 50;
                GoldenRingCooldown++;
                GoldenSparkleCooldown++;
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().ParticlesToggle == true && (ZoneCinder || ZoneDrakonic))
            {
                Main.windPhysicsStrength = 50;
            ...
            if (ModContent.GetInstance<UrdveilClientConfig>().VanillaParticlesToggle == true && Player.ZoneUnderworldHeight)
            {
                Main.windPhysicsStrength = 50;
                GoldenRingCooldown++;
                GoldenSparkleCooldown++;
        ...
        public override void PostUpdateEquips()
        {
            ...
            if (ArcaneM)
            {
                ...
                {
                    SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/ArcaneExplode"));
                }
