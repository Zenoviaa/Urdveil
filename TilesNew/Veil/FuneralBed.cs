...
namespace Urdveil.TilesNew.Veil
{
    //Wall Version
    public class FuneralBedItem : DecorativeWallItem
    {
        ...
        {
            base.SetDefaults();
            Item.createWall = ModContent.WallType<FuneralBed>();
        }

        public override void PostDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            Texture2D iconTexture = ModContent.Request<Texture2D>("Urdveil/Tiles/ExampleDecorativeWallItem").Value;
