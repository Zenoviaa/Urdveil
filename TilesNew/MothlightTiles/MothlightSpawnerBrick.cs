...
namespace Urdveil.TilesNew.MothlightTiles
{
    public class MothlightSpawnerBrick : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<MothlightSpawnerBrickBlock>());
        ...
        public class MothlightSpawnerBrickBlock : ModItem
        {
            public override void SetStaticDefaults()
            {
            ...
            public override void SetDefaults()
            {
                ...
                Item.createTile = ModContent.TileType<MothlightSpawnerBrick>();
            }
