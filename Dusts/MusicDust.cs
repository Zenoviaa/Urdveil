...
namespace Urdveil.Dusts
{
    public class MusicDust : ModDust
    {
        ...
        public override bool Update(Dust dust)
        {
            ...
            dust.scale *= 0.98f;
            Vector2 nextCenter = dust.position + Vector2.One.RotatedBy(dust.rotation + 0.001f) * 32 * dust.scale;

            dust.rotation += 0.001f;
