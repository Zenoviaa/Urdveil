...
namespace Urdveil.UI.MapSystem
{
    internal class MapButton : UIPanel
    {
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(TextureAsset.Value, rectangle.TopLeft() + new Vector2(Width.Pixels / 2, Height.Pixels / 2) - new Vector2(TextureAsset.Value.Width, TextureAsset.Value.Height) / 2, null, color2, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
