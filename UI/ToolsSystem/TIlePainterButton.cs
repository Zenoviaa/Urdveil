...
{
    internal class TilePainterButton : UIPanel
    {
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            if (IsMouseHovering)
            {
                textureToDraw = ModContent.Request<Texture2D>(ToolsUISystem.RootTexturePath + "TilePainterSelected").Value;
            }
            else
            {
                textureToDraw = ModContent.Request<Texture2D>(ToolsUISystem.RootTexturePath + "TilePainter").Value;
            }
