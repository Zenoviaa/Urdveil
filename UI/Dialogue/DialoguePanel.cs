...
namespace Urdveil.UI.Dialogue
{
    internal class DialoguePanel : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            Box = new UIImage(ModContent.Request<Texture2D>("Urdveil/UI/Dialogue/DialogueBox"));
            Box.Color = Color.White * 0.66f;
            Box.Width.Set(701, 0);
            Box.Height.Set(200, 0);
            UIPanel.Append(Box);

            Portrait = new UIImage(ModContent.Request<Texture2D>("Urdveil/UI/Dialogue/ExampleDialoguePortrait"));
