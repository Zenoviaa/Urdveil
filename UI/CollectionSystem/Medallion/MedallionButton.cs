    ...
    internal class MedallionButton : UIPanel
    {
        ...
        public override void OnInitialize()
        {
            ...
            FragmentTexture = ModContent.Request<Texture2D>(
                $"{CollectionBookUISystem.RootTexturePath}Medallion/Fragment{_fragment.Number}", ReLogic.Content.AssetRequestMode.ImmediateLoad);
        ...
        {
            UrdFragmentPlayer fragmentPlayer = Main.LocalPlayer.GetModPlayer<UrdFragmentPlayer>();
