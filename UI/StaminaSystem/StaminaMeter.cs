...
namespace Urdveil.UI.StaminaSystem
{
    ...
    {
        private string AssetDirectory = $"Urdveil/UI/StaminaSystem/";
        private Texture2D
            _staminaMeterEmpty,
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            ComboPlayer comboPlayer = Main.LocalPlayer.GetModPlayer<ComboPlayer>();
