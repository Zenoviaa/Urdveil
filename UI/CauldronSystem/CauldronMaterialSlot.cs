    ...
    internal class CauldronMaterialSlot : UIElement
    {
        ...
        internal CauldronMaterialSlot(int context = ItemSlot.Context.InventoryItem, float scale = 1f)
        {
            ...
            var asset = ModContent.Request<Texture2D>(
                $"{CauldronUISystem.RootTexturePath}CauldronMaterialSlot", ReLogic.Content.AssetRequestMode.ImmediateLoad);
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            Texture2D backingTexture = ModContent.Request<Texture2D>($"{CauldronUISystem.RootTexturePath}CauldronMaterialSlot").Value;
