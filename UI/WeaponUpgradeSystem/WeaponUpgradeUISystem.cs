...
using Urdveil.Common.WeaponUpgrade;
...
namespace Urdveil.UI.WeaponUpgradeSystem
{
    ...
    internal class WeaponUpgradeUISystem : BaseUISystem
    {
        ...
        public static string RootTexturePath => "Urdveil/UI/WeaponUpgradeSystem/";
        ...
        public void Reforge()
        {
            ...
            SoundEngine.PlaySound(new SoundStyle($"Urdveil/Assets/Sounds/Converted"));
        }
        ...
        public override void ModifyInterfaceLayers(List<GameInterfaceLayer> layers)
        {
            ...
            if (mouseTextIndex != -1)
            {
                layers.Insert(mouseTextIndex, new LegacyGameInterfaceLayer(
                    "Urdveil: Weapon Upgrade Damage UI",
                    delegate
                    {
