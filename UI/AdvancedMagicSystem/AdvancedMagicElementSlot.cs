...
namespace Urdveil.UI.AdvancedMagicSystem
{
    internal class AdvancedMagicElementSlot : UIElement
    {
        ...
        internal AdvancedMagicElementSlot(int context = ItemSlot.Context.BankItem, float scale = 1f)
        {
            ...
            var v = ModContent.Request<Texture2D>("Urdveil/UI/AdvancedMagicSystem/ElementSlot", ReLogic.Content.AssetRequestMode.ImmediateLoad);
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            Texture2D value = ModContent.Request<Texture2D>("Urdveil/UI/AdvancedMagicSystem/ElementSlot").Value;
