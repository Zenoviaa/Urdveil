...
using Urdveil.Items.MoonlightMagic;
using System;
using Terraria;
...
namespace Urdveil.UI.AdvancedMagicSystem
{
    internal class AdvancedMagicStaffSlot : UIElement
    {
        ...
        internal AdvancedMagicStaffSlot(BaseStaff staff, int index, bool isTimedSlot, int context = ItemSlot.Context.BankItem, float scale = 1f)
        {
            ...
            var asset = ModContent.Request<Texture2D>("Urdveil/UI/AdvancedMagicSystem/EnchantmentCard", ReLogic.Content.AssetRequestMode.ImmediateLoad);
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            Texture2D cardTexture = _isTimedSlot
                ? ModContent.Request<Texture2D>("Urdveil/UI/AdvancedMagicSystem/TimedEnchantmentCard").Value
                : ModContent.Request<Texture2D>("Urdveil/UI/AdvancedMagicSystem/EnchantmentCard").Value;
            ...
            cardTexture = _isTimedSlot
                ? ModContent.Request<Texture2D>("Urdveil/UI/AdvancedMagicSystem/TimedEnchantmentSlot").Value
                : ModContent.Request<Texture2D>("Urdveil/UI/AdvancedMagicSystem/EnchantmentSlot").Value;
            ...
            //Draw Orb Thingy
            cardTexture = ModContent.Request<Texture2D>("Urdveil/UI/AdvancedMagicSystem/EnchantmentOrb").Value;
            /*
