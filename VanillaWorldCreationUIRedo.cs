...
namespace Urdveil
{
    ...
    internal class VanillaWorldCreationUIRedo : ModSystem
    {
        ...
        {
            base.Load();
            _SizeSmallTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewSizeWorldVeil");
            _SizeMediumTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewSizeWorldVeil");
            _SizeLargeTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewSizeWorldVeil");

            _EvilRandomTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewBlankWorld");
            _EvilCorruptionTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewBlankWorld");
            _EvilCrimsonTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewBlankWorld");


            _BunnyMasterTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewDifficultyMaster");
            _BunnyExpertTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewDifficultyExpert");
            _BunnyNormalTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewDifficultyNormal");
            _BunnyCreativeTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewDifficultyMJourny");

            _BorderTexture = ModContent.Request<Texture2D>("Urdveil/Assets/Textures/UI/PreviewBorder");
        ...
        private void DrawWorldPreviewUI(On_UIWorldCreationPreview.orig_DrawSelf orig, UIWorldCreationPreview self, SpriteBatch spriteBatch)
        {
            ...
            if (!ModContent.GetInstance<UrdveilClientConfig>().VanillaUIRespritesToggle)
            {
                orig(self, spriteBatch);
                return;
            }
