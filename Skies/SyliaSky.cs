    ...
    public class SyliaSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            if (maxDepth >= 2 && minDepth < 2)
            {
                ...
                storm.Parameters["uTexture1"].SetValue(ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/Noise8").Value);
                ...
                storm.Parameters["uColorMap"].SetValue(ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/ColorMap4").Value);
