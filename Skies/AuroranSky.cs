...
namespace Urdveil.Skies
{
    public class AuroranSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            {
                Texture2D Tex = ModContent.Request<Texture2D>("Urdveil/Assets/Effects/SkyGradient1").Value;
                Texture2D Tex2 = ModContent.Request<Texture2D>("Urdveil/Assets/Effects/SkyGradient2").Value;
