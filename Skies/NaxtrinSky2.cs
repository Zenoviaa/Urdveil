...
namespace Urdveil.Skies
{
    public class NaxtrinSky2 : CustomSky
    {
        ...
        public static Effect Neffect = ModContent.Request<Effect>("Urdveil/Effects/Primitives/NaxtrinSky", AssetRequestMode.ImmediateLoad).Value;
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            if (maxDepth >= 2 && minDepth < 2)
            {
                ...
                storm.Parameters["uTexture0"].SetValue(ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/Noise7").Value);
                storm.Parameters["uTexture1"].SetValue(ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/CloudNoise").Value);
                ...
                storm.Parameters["uColorMap"].SetValue(ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/ColorMap8").Value);
                ...
                //glowing up the sky
                Texture2D backGlow = (ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/Backglow").Value);
            ...
            if (maxDepth >= 2 && minDepth < 2)
            {
                ...
                storm.Parameters["uColorMap"].SetValue(ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/ColorMap6").Value);
                storm.Parameters["uColorMapSection"].SetValue(0.2f);
