...
using Urdveil.Helpers.Separate;
using System;
...

{
    ...
    public class GovheilSkyScene : ModSceneEffect
    {
        ...
        {
            player.ManageSpecialBiomeVisuals("Urdveil:GovheilSky", isActive);
            if (isActive)
                SkyManager.Instance["Urdveil:GovheilSky"].Update(new());
        }
    }
    ...
    public class GovheilSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            // Draw the sky and moon.
                ...
                Texture2D skyTexture = ModContent.Request<Texture2D>("Urdveil/Skies/GovheilSky").Value;
        ...
        {
            Texture2D noise = ModContent.Request<Texture2D>("Urdveil/Assets/NoiseTextures/BlurryPerlinNoise", AssetRequestMode.ImmediateLoad).Value;
        ...
        {
            // Draw the moon.
            Texture2D bloom = ModContent.Request<Texture2D>("Urdveil/Skies/Piece").Value;//InfernumTextureRegistry.DistortedBloomRing.Value;
        ...
        private void DrawCinders(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            for (int i = 0; i < Cinders.Count; i++)
            {
                ...
                cinder.Update();
                Texture2D cinderTexture = cinder.Bubble ? ModContent.Request<Texture2D>("Urdveil/Trails/CircleGradient").Value : ModContent.Request<Texture2D>("Urdveil/Trails/Star").Value;
