...
using Urdveil.UI.AdvancedMagicSystem;
    ...
    internal abstract class BaseStaff : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            tooltipLine = new TooltipLine(Mod, "WeaponType",
                Language.GetTextValue("Mods.Urdveil.Enchantments.EnchantmentCommonStaff"));
            tooltipLine.OverrideColor = Color.White;
            tooltips.Add(tooltipLine);

            tooltipLine = new TooltipLine(Mod, "EnchantHelp",
                Language.GetTextValue("Mods.Urdveil.Enchantments.EnchantmentCommonStaffHelp"));
