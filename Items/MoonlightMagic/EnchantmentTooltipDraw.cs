...
namespace Urdveil.Items.MoonlightMagic
{
    internal class EnchantmentTooltipDraw : GlobalItem
    {
        public override bool PreDrawTooltipLine(Item item, DrawableTooltipLine line, ref int yOffset)
        {
            ...
            if (line.Mod == "Urdveil" && line.Name.Contains("MoonMagicEnchant_"))
            {
            ...
            if (line.Mod == "Urdveil" && line.Name.Contains("WeaponType"))
            {
                if (item.ModItem is BaseStaff ele)
                {
            ...
            bool isEnchantTooltip = line.Mod == "Urdveil" && line.Name == "EnchantmentTooltip";
            bool isSynergyTooltip = line.Mod == "Urdveil" && line.Name == "SynergyHelp";
