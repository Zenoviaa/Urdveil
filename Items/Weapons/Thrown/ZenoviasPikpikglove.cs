...
using Urdveil.Projectiles.Pikmin;
using Terraria;
...
{
    public class ZenoviasPikpikGlove : ClassSwapItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                case 0:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Pikminthrow1") with { Volume = 0.5f }, position);
                    break;

                case 1:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Pikminthrow2") with { Volume = 0.4f }, position);
                    break;

                case 2:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Pikminthrow3") with { Volume = 0.4f }, position);
                    break;

                case 3:
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Pikminthrow4") with { Volume = 0.4f }, position);
                    break;
