...
namespace Urdveil.Items.Weapons.Mage.Tomes
{
    internal class VoidsGrasp : BaseMagicTomeItem
    {
        ...
        {
            base.SetDefaults();
            Item.shoot = ModContent.ProjectileType<VoidsGraspTome>();
            Item.shootSpeed = 25;
        }
    }
    ...
    internal class VoidsGraspTome : BaseMagicTomeProjectile
    {
        ...
        protected override void Shoot(Player player, IEntitySource source, Vector2 position, Vector2 velocity, int damage, float knockback)
        {
            ...
            {
                Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<VoidHandSpawn>(), damage, knockback, Projectile.owner);
            }
        }
    }
}
