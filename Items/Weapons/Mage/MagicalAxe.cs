    ...
    public class MagicalAxeBoomer : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 10)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/StarFlower3"), Projectile.position);
            ...
            if (Timer == 30)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/StarSheith"), Projectile.position);
                FXUtil.ShakeCamera(Projectile.position, 1024, 4);
                Projectile.Kill();
            }
