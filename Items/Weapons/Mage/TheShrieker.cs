...
namespace Urdveil.Items.Weapons.Mage
{
    ...
    public class ShriekerWave : ModProjectile
    {
        ...
        private ref float Timer => ref Projectile.ai[0];
        public override string Texture => "Urdveil/Assets/NoiseTextures/Extra_67";
        public override void SetDefaults()
        {
            base.SetDefaults();
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                ...
                SoundStyle mySound = new SoundStyle("Urdveil/Assets/Sounds/TheDeafen");
                if (Sound == 1)
                {
                ...
                {
                    mySound = new SoundStyle("Urdveil/Assets/Sounds/TheDeafen2");
                }
