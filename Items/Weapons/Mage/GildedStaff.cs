...
namespace Urdveil.Items.Weapons.Mage
{
    ...
    public class GildedStaffHold : ModProjectile
    {
        ...
        private void AI_Charge()
        {
            ...
            if (Timer == 1)
            {
                SoundStyle mySound = new SoundStyle("Urdveil/Assets/Sounds/StormKnight_Rechage");
    ...
    public class GildedStaffBlast : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer == 1)
            {
                ...
                SoundStyle mySound = new SoundStyle("Urdveil/Assets/Sounds/Starblast");
                mySound.PitchVariance = 0.3f;
                SoundEngine.PlaySound(mySound, Projectile.position);

                mySound = new SoundStyle("Urdveil/Assets/Sounds/StarFlower1");
                mySound.PitchVariance = 0.3f;
                SoundEngine.PlaySound(mySound, Projectile.position);
