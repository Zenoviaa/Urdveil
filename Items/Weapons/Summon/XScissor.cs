...
using Urdveil.Projectiles.Summons.Sentries;
...
namespace Urdveil.Items.Weapons.Summon
{
    ...
    public class XScissor : ClassSwapItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.UseSound = new SoundStyle("Urdveil/Assets/Sounds/RipperSlashTelegraph");
        ...
        public override bool CanUseItem(Player player)
        {
            if (player.altFunctionUse == 2 && player.GetModPlayer<SewingKitPlayer>().hasSewingKit)
            {
                ...
                {
                    case 0:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SwordOfGlactia1"), player.position);
                        break;
                    case 1:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SwordOfGlactia2"), player.position);
                        break;
                    case 2:
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SwordOfGlactia3"), player.position);
                        break;
                }
                return false;
            }
        ...
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            if (_attackStyle == 1)
            {
                Texture2D iconTexture = ModContent.Request<Texture2D>("Urdveil/Items/Weapons/Melee/XScissorMiracle").Value;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            else
            {
                ...
                {
                    SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/AssassinsKnifeProg");
                ...
                {
                    SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/AssassinsKnifeProg2");
                    soundStyle.PitchVariance = 0.15f;
                    soundStyle.Pitch = 0.75f + speedProgress * 0.2f;
                    SoundEngine.PlaySound(soundStyle, player.position);
                }
