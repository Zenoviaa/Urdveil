        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            if (player.altFunctionUse != 2)
            {
                ...
                else
                {
                    ...
                    {
                        case 0:
                            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/AssassinsKnifeProg"), player.position);
                            break;
                        case 1:
                            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/AssassinsKnifeProg2"), player.position);
                            break;
                    }
