...
using Urdveil.Projectiles.Swords.Fenix;
...
namespace Urdveil.Items.Weapons.Melee
{
    public class Yumiko : ClassSwapItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            if (Sound == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Yumiko"), position);
            }
            if (Sound == 2)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Yumiko2"), position);
            }
            if (Sound == 3)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Yumiko3"), position);

            }
            if (Sound == 4)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Yumiko4"), position);
