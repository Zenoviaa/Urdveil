...
using Urdveil.Projectiles.Slashers.GrailAxe;
...
namespace Urdveil.Items.Weapons.Melee
{
    public class GrailAxe : ClassSwapItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.UseSound = new SoundStyle("Urdveil/Assets/Sounds/StarSheith");
            Item.autoReuse = true;
        ...
        public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback)
        {
            ...
            {
                type = ModContent.ProjectileType<GrailAxeProj>();
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/StormDragon_Bomb"), player.position);
            }
        }
