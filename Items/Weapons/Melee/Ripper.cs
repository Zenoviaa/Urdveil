...
using Urdveil.Projectiles.Swords.Ripper;
...
namespace Urdveil.Items.Weapons.Melee
{
    ...
    public class Ripper : ClassSwapItem
    {
        ...
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            if (_attackStyle == 1)
            {
                Texture2D iconTexture = ModContent.Request<Texture2D>("Urdveil/Items/Weapons/Mage/SkyFractureMiracle").Value;
