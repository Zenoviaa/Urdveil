...
using Urdveil.Projectiles.Slashers.Dula;
...
namespace Urdveil.Items.Weapons.Melee.Greatswords
{
    public class Tulahal : ClassSwapItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/RekShockwave") { Pitch = Main.rand.NextFloat(-10f, 10f) }, player.Center);
