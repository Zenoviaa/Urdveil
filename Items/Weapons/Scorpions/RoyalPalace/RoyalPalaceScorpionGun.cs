...
namespace Urdveil.Items.Weapons.Scorpions.RoyalPalace
{
    ...
    internal class RoyalPalaceScorpionGun : BaseScorpionGun
    {
        protected override void Shoot()
        {
            ...
            if (Sound == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/MiniPistol"), Projectile.position);
            }
            else
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/MiniPistol3"), Projectile.position);
            }
