    ...
    internal class TheWiggler : ClassSwapItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/clickk"));
                return false;
            }
            ...
            switch (Main.rand.Next(0, 3))
            {
                default:
                case 0:
                    soundPath = "Urdveil/Assets/Sounds/WigglerShot";
                    break;
                case 1:
                    soundPath = "Urdveil/Assets/Sounds/WigglerShot2";
                    break;
                case 2:
                    soundPath = "Urdveil/Assets/Sounds/WigglerShot3";
                    break;
            }
