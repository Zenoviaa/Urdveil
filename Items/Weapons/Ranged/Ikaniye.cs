...
namespace Urdveil.Items.Weapons.Ranged
{
    public class Ikaniye : ClassSwapItem
    {
        ...
        public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback)
        {
            ...
            if (Sound == 1)
            {
                SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunBigNew1");
           ...
           IPixelPrimitiveDrawer
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle($"{nameof(Urdveil)}/Assets/Sounds/MorrowExp"), target.position);
            ...
            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Vinger2"), target.position);
            for (int i = 0; i < 14; i++)
            {
            ...
            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Vinger"), target.position);
            ShakeModSystem.Shake = 4;
            for (int i = 0; i < 6; i++)
            {
