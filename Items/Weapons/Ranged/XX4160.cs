    ...
    public class XX4160 : ClassSwapItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                {
                    LAZERMode = false;
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/XX41604"));
                }
                else
                {
                    LAZERMode = true;
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/XX41603"));
                }
            }
            else
            {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            if (Sound == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/MiniPistol"));
            }
            else
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/MiniPistol3"));
            }
            ...
            if (LAZERMode && !player.HasBuff(ModContent.BuffType<Overheated>()))
            {
                ...
                if (Sound2 == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/XX4160"));
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/XX41602"));
                }
