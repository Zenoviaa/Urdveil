...
namespace Urdveil.Items.Weapons.Ranged
{
    internal class Shredder : ClassSwapItem
    {
        ...
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            if (_attackStyle == 1)
            {
                Texture2D iconTexture = ModContent.Request<Texture2D>("Urdveil/Items/Weapons/Mage/RainbowRodMiracle").Value;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/StormDragon_CloudBolt"), player.position);
