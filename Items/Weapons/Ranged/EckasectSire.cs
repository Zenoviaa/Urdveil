...
using Urdveil.Projectiles.Crossbows.Eckasect;
...
namespace Urdveil.Items.Weapons.Ranged
{
    ...
    public class EckasectSire : ClassSwapItem
    {
        ...
        //Texture2D iconTexture = ModContent.Request<Texture2D>("Urdveil/Items/Accessories/Brooches/AdvancedBroochesBackpack").Value;
        ...
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            if (!player.HasBuff<Genesis>() && !player.HasBuff<Liberator>() && !player.HasBuff<Executor>())
            {
                Texture2D iconTexture = ModContent.Request<Texture2D>("Urdveil/Items/Weapons/Ranged/EckasectSire").Value;
                spriteBatch.Draw(iconTexture, position, null, drawColor, 0f, origin, scale, SpriteEffects.None, 0);
                return false;
            }
            ...
            {
                Texture2D iconTexture = ModContent.Request<Texture2D>("Urdveil/Items/Weapons/Ranged/EckasectLiber").Value;
                spriteBatch.Draw(iconTexture, position, null, drawColor, 0f, origin, scale, SpriteEffects.None, 0);
                return false;
            }
            ...
            {
                Texture2D iconTexture = ModContent.Request<Texture2D>("Urdveil/Items/Weapons/Ranged/EckasectExe").Value;
                spriteBatch.Draw(iconTexture, position, null, drawColor, 0f, origin, scale, SpriteEffects.None, 0);
                return false;
            }
