...
using Urdveil.Projectiles.GunHolster;
using Urdveil.Projectiles.Steins;
...
namespace Urdveil.Items.Weapons.Ranged.GunSwapping
{
    ...
    internal class Pulsing : MiniGun
    {
        ...
        public override void Fire(Player player, Vector2 position, Vector2 velocity, int damage, float knockback)
        {
            ...
            if (player.PickAmmo(Item, out int projToShoot, out float speed, out int newDamage, out float knockBack, out int usedAmmoItemId))
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/MiniPistol"), position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/MiniPistol3"), position);
                }
            }
        }
    }
    ...
    internal class Eagle : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/MiniPistol3");
    ...
    internal class BurnBlast : MiniGun
    {
        ...
        public override void Fire(Player player, Vector2 position, Vector2 velocity, int damage, float knockback)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/gun1"), position);
        }
    }
    ...
    internal class MintyBlast : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/HarmonicBlasphemy1");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
    ...
    internal class MsFreeze : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunLaser");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
    ...
    internal class Piken : MiniGun
    {
        ...
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunShootNew1");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
        ...
        public override void Fire(Player player, Vector2 position, Vector2 velocity, int damage, float knockback)
        {
            ...
            if (_comboCounter > 100)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/MiniPistol2"));
                AttackSpeed = 30;
                _comboCounter = 0;
            }
            if (_comboCounter > 75)
            ...
            if (Sound == 1)
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/GunShootNew6"));
            }
            else
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/GunShootNew6"));
    ...
    internal class Electrifying : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunElectric");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
        ...
        public override void Fire(Player player, Vector2 position, Vector2 velocity, int damage, float knockback)
        {
            ...
            if (player.PickAmmo(Item, out int projToShoot, out float speed, out int newDamage, out float knockBack, out int usedAmmoItemId))
            {
                ...
                SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunShootNew9");
                soundStyle.PitchVariance = 0.5f;
                SoundEngine.PlaySound(soundStyle, position);
            }
        }
    ...
    internal class RavestBlast : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunRaving");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
    ...
    internal class CinderNeedle : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/Gunsotp");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
    ...
    internal class Drygan : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunShootNew5");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
    ...
    internal class Obel : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunShootNew10");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
    ...
    internal class Piranha : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunShootNew4");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
    ...
    internal class BubbleBussy : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/TentacleBubbleOut");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
    ...
    internal class BasterParty : MiniGun
    {
        ...
        {
            base.Fire(player, position, velocity, damage, knockback);
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunShootNew11");
    ...
    internal class MeredaX : MiniGun
    {
        public override void SetDefaults()
        {
            ...
            SoundStyle soundStyle = new SoundStyle("Urdveil/Assets/Sounds/GunBlasting");
            soundStyle.PitchVariance = 0.5f;
            Item.UseSound = soundStyle;
