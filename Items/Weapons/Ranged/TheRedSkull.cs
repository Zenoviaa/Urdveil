...
namespace Urdveil.Items.Weapons.Ranged
{
    public class RedSkullPlayer : ModPlayer
    {
        ...
        public override void ModifyHitNPCWithProj(Projectile proj, NPC target, ref NPC.HitModifiers modifiers)
        {
            ...
            {
                hitCount++;
                SoundStyle sound = new SoundStyle("Urdveil/Assets/Sounds/Pericarditis");
                ...
                if (hitCount >= 3)
                {
                    ...
                    if (Sound == 1)
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dreadmire_BoneSpawn1"), proj.position);
                    }
                    else
                    {
                        SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/Dreadmire_BoneSpawn2"), proj.position);
                    }
