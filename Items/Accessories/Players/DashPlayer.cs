...
namespace Urdveil.Items.Accessories.Players
{
    ...
    internal class DashPlayer : ModPlayer
    {
        ...
        public override void PreUpdateMovement()
        {
            ...
            if (CanUseDash() && (UrdveilKeybinds.DashKeybind.JustPressed || DoubleTapped) && DashDir != -1 && DashDelay == 0 && DashCount > 0 && Main.myPlayer == Player.whoAmI)
            {
