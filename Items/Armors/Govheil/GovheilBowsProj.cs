...
namespace Urdveil.Items.Armors.Govheil
{
    public class GovheilBowsProj : ModProjectile
    {
        ...
        {
            Texture2D texture2D4 = Request<Texture2D>("Urdveil/Trails/DimLight").Value;
            ...
            Texture2D texture2D5 = Request<Texture2D>("Urdveil/Trails/DimLight").Value;
            ...
            Texture2D texture2D6 = Request<Texture2D>("Urdveil/Trails/DimLight").Value;
            ...
            Texture2D texture2D7 = Request<Texture2D>("Urdveil/Trails/DimLight").Value;
