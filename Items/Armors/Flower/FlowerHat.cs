...
using Urdveil.Projectiles.Arrows;
using Urdveil.Projectiles.Chains;
using Terraria;
...
namespace Urdveil.Items.Armors.Flower
{
    ...
    internal class FlowerPlayer : ModPlayer
    {
        ...
        public override void ModifyShootStats(Item item, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback)
        {
            ...
            {
                SoundEngine.PlaySound(new SoundStyle("Urdveil/Assets/Sounds/SwordThrow"), position);
