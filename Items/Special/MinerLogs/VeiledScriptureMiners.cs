...
using Urdveil.UI.Scripture;
using Terraria;
using Terraria.ID;
using Terraria.ModLoader;

namespace Urdveil.Items.Special.MinerLogs
{
    internal abstract class VeiledScriptureMiner : ModItem
    {
        public override string Texture => "Urdveil/Items/Special/MinerLogs/VeiledScriptureMiner1";
        ...
        public override bool? UseItem(Player player)
        {
            ...
            scriptureSystem.Panel.Popup.Texture = "Urdveil/UI/Scripture/MinerScripture";
